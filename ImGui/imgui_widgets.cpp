...
inline ImColor background_color(12, 12, 12, 255);

inline ImColor second_color(63, 92, 165, 255);
...
bool ImGui::ButtonEx(const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags)
{
    ...
    it_anim->second.button_color = ImLerp(it_anim->second.button_color, held ? main_color : hovered ? ImColor(94, 136, 242, 255) : ImColor(78, 125, 242, 255), g.IO.DeltaTime * 8.f);
...
bool ImGui::InputTextEx(const char* label, const char* hint, char* buf, int buf_size, const ImVec2& size_arg, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback, void* callback_user_data)
{
    ...
    it_anim->second.background_color = ImLerp(it_anim->second.background_color, IsItemActive() ? ImColor(22, 22, 22) : hovered ? ImColor(14, 14, 14) : ImColor(14, 14, 14), g.IO.DeltaTime * 8.f);
    it_anim->second.text_color = ImLerp(it_anim->second.text_color, IsItemActive() ? ImColor(255, 255, 255) : ImColor(0.35f, 0.35f, 0.35f, 1.f), g.IO.DeltaTime * 8.f);
    ...
    if (!is_multiline)
    {
        ...
        window->DrawList->AddRect(frame_bb.Min, frame_bb.Max, ImColor(63 / 255.f, 92 / 255.f, 165 / 255.f, content_animation * 0.1f + it_anim->second.hovered_anim), style.FrameRounding, 5.f);
    }
            ...
            for (const ImWchar* p = text_selected_begin; p < text_selected_end; )
            {
                ...
                else
                {
                    ...
                    if (rect.Overlaps(clip_rect))
                        draw_window->DrawList->AddRectFilled(rect.Min, rect.Max + ImVec2(0, 10.f), ImColor(255, 255, 255));
                }
    ...
    {
        window->DrawList->AddText(ImVec2(frame_bb.Min.x + CalcTextSize(label).y / 2 + style.ItemInnerSpacing.x, frame_bb.Min.y + size_arg.y / 2 - CalcTextSize(label).y / 2), GetColorU32(it_anim->second.text_color), label);
    }
...
bool ImGui::BeginMenuBar()
{
    ...
    // We overwrite CursorMaxPos because BeginGroup sets it to CursorPos (essentially the .EmitItem hack in EndMenuBar() would need something ana
    // us here, maybe a BeginGroupEx() with flags).
